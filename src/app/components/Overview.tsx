...
const Overview = () => {
  ...
  return (
    <div className="min-h-[150vh] flex flex-col items-center">
      ...
      <div
        className={`px-4 md:px-0 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 container pb-10 transition-opacity duration-500 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
        <div className="flex flex-col gap-2 order-1">
          <h1 className="text-2xl md:text-4xl text-white tracking-tight">Lyra</h1>
        ...
        <div 
          ...
          onClick={() => setExpandedVideo("https://my-website-videos-akport.s3.us-east-1.amazonaws.com/Personalized+Chrome+Extension.mp4")}
        >
          <video autoPlay muted loop playsInline preload="auto" className="rounded-lg">
            <source src="https://my-website-videos-akport.s3.us-east-1.amazonaws.com/Personalized+Chrome+Extension.mp4" type="video/mp4" />
          </video>
        </div>
      </div>
      <div
      ...
      >
        <div className="flex flex-col gap-2 order-1">
          <h1 className="text-2xl md:text-4xl text-white tracking-tight">Sunday</h1>
          <p className="text-gray-400 text-sm md:text-lg">
        ...
        <div 
          className="order-2 cursor-pointer" 
          onClick={() => setExpandedVideo("https://my-website-videos-akport.s3.us-east-1.amazonaws.com/Introducing+Sundae+AI+Assistant.mp4")}
        >
          <video autoPlay muted loop playsInline preload="auto" className="rounded-lg">
            <source src="https://my-website-videos-akport.s3.us-east-1.amazonaws.com/Introducing+Sundae+AI+Assistant.mp4" type="video/mp4" />
          </video>
        </div>
      </div>
